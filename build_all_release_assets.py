...
# Step 4: Poster PDFs (A0, A1, A2)
print("\n[5/7] Generisanje ISO A0, A1, A2 poster PDF formata...")
subprocess.run(["python", "generate_poster_pdfs.py"], check=True)

# Step 5: GEDCOM Export
print("\n[6/7] Generisanje standardnog GEDCOM fajla...")
subprocess.run(["python", "generate_gedcom.py"], check=True)
